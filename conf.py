...
BLOG_AUTHOR = "Niko Skrypnik"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('https://github.com/nskrypnik', 'My Github', 'fab fa-github'),
        ('https://www.linkedin.com/in/niko-skrypnik-74157338/', 'My LinkedIn', 'fab fa-linkedin'),
        ('https://facebook.com/niko.skrypnik', 'My Twitter', 'fab fa-facebook-square'),
    ),
}
...
# is in the manual.
COMMENT_SYSTEM_ID = "1887123258247142"
...
BODY_END = '''
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-122096558-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-122096558-1');
    </script>
'''
